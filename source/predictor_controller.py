...
class NERPredictor(NERControllerCaller, ConfigReader):
    def __init__(self, **kwargs):
        ...
        self.ner_controller_object = self._create_ner_controller_object(self.__config)
...
class MaskedPredictor(MaskedControllerCaller, ConfigReader):
    def __init__(self, **kwargs):
        ...
        self.__config: Dict[str, ModelControllerOptions] = self._read_config()
        self.masked_controller_object = self._create_masked_controller_object(self.__config)
